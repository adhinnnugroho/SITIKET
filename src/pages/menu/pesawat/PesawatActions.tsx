...
const PesawatActions = () => {
    ...
    const switchValue = () => {
        // Simpan sementara nilai departure
        const temp = departureValue;
        // Tukar nilai departure dan arrival
            ...
            <div className="h-[50rem]">
                <div className="relative">
                    <div className="mb-[90rem]">
                        <ComponentManagement.PesanCard image={AssetsManagement.Pesawat} link={'/'} />
                        <div className="absolute top-24 px-2 w-full z-10 " >
                            <div className="rounded-lg bg-white p-3 w-full h-auto">
                                <h1 className="text-2xl font-bold  text-black">Pesawat</h1>
                                ...
                                <div className="mt-5">
                                    <div className="p-4 bg-gray-100 rounded-lg">
                                        <div className="flex flex-col items-start" data-testid="clickable-departure-input">
                                            ...
                                            <div>
                                                <span className="text-gray-900 text-lg font-bold">
                                                    {departureValue.name} <span className="text-gray-500 ml-1">{departureValue.code}</span>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col items-start" data-testid="clickable-arrival-input">
                                            ...
                                            <div>
                                                <span className="text-gray-900 text-lg font-bold">
                                                    {arrivalValue.name} <span className="text-gray-500 ml-1">{arrivalValue.code}</span>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="space-x-4 p-4 bg-gray-100 mt-4 rounded-md">
                                    <span className="text-lg font-bold text-gray-800">1 Penumpang, Ekonomi</span>
                                </div>
