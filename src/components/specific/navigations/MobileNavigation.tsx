...
const MobileNavigation = () => {
    return (
        <div className="w-screen  fixed bottom-0 border z-20 border-transparent dark:border-t-gray-100 border-t-gray-600 p-2  dark:bg-black bg-white dark:text-white text-black transition-all duration-700 ease-in-out ">
